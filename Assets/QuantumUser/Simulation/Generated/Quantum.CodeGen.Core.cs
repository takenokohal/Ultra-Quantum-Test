...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct TimeCounter {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct AllPlayersManager : Quantum.IComponentSingleton {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    public QListPtr<EntityRef> AllPlayers;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 179;
        hash = hash * 31 + AllPlayers.GetHashCode();
        return hash;
      }
    }
    ...
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.AllPlayersManager*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (AllPlayersManager*)ptr;
        QList.Serialize(&p->AllPlayers, serializer, Statics.SerializeEntityRef);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct FireShoot : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 11411;
        hash = hash * 31 + TimeCounter.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        Quantum.TimeCounter.Serialize(&p->TimeCounter, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct UltraPlayer : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetRef<UltraPlayerConfig> PlayerConfig;
    [FieldOffset(8)]
    public TimeCounter BulletCoolTimeTimeCounter;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 12119;
        hash = hash * 31 + PlayerConfig.GetHashCode();
        hash = hash * 31 + BulletCoolTimeTimeCounter.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (UltraPlayer*)ptr;
        AssetRef.Serialize(&p->PlayerConfig, serializer);
        Quantum.TimeCounter.Serialize(&p->BulletCoolTimeTimeCounter, serializer);
    }
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.AllPlayersManager>();
      BuildSignalsArrayOnComponentRemoved<Quantum.AllPlayersManager>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.FireShoot>();
      BuildSignalsArrayOnComponentRemoved<Quantum.FireShoot>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.UltraPlayer>();
      BuildSignalsArrayOnComponentRemoved<Quantum.UltraPlayer>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      typeRegistry.Register(typeof(Quantum.AllPlayersManager), Quantum.AllPlayersManager.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.FireShoot), Quantum.FireShoot.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.TimeCounter), Quantum.TimeCounter.SIZE);
      typeRegistry.Register(typeof(Transform2D), Transform2D.SIZE);
      typeRegistry.Register(typeof(Transform2DVertical), Transform2DVertical.SIZE);
      typeRegistry.Register(typeof(Transform3D), Transform3D.SIZE);
      typeRegistry.Register(typeof(Quantum.UltraPlayer), Quantum.UltraPlayer.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 5)
        ...
        .Add<Quantum.AllPlayersManager>(Quantum.AllPlayersManager.Serialize, null, Quantum.AllPlayersManager.OnRemoved, ComponentFlags.Singleton)
        .Add<Quantum.Bullet>(Quantum.Bullet.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.FireShoot>(Quantum.FireShoot.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.PlayerLink>(Quantum.PlayerLink.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.UltraPlayer>(Quantum.UltraPlayer.Serialize, null, null, ComponentFlags.None)
        .Finish();
    }
    [Preserve()]
